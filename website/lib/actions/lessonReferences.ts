...
export const createLessonReferenceAction = async (input: NewLessonReferenceParams) => {
  try {
...
export const updateLessonReferenceAction = async (input: UpdateLessonReferenceParams) => {
  try {
