...
import OptimisticChapter from '@/app/(app)/chapters/[chapterId]/OptimisticChapter';
...
const Chapter = async ({ id }: { id: string }) => {
  const { chapter, chapterContents } =
    await getChapterByIdWithChapterContents(id);
    ...
    <Suspense fallback={<Loading />}>
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">
          {chapter.title}&apos;s Chapter Contents
        </h3>
        <ChapterContentList
          chapters={[]}
