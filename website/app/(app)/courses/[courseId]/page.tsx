...
const Course = async ({ id }: { id: string }) => {
  ...
  const { course, courseObjectives, lessons } = await getCourseByIdWithCourseObjectivesAndLessons(id);
  ...
  return (
    <Suspense fallback={<Loading />}>
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{course.title}&apos;s Course Objectives</h3>
        <CourseObjectiveList
          courses={[]}
          courseId={course.id}
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{course.title}&apos;s Lessons</h3>
        <LessonList
          courses={[]}
          courseId={course.id}
          lessons={lessons}
