...
export default function OptimisticLessonObjective({ 
  ...
  const [optimisticLessonObjective, setOptimisticLessonObjective] = useOptimistic(lessonObjective);
  ...
  return (
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">{optimisticLessonObjective.objective}</h1>
