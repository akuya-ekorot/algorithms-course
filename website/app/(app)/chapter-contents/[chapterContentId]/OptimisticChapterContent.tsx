...
export default function OptimisticChapterContent({ 
  ...
  const [optimisticChapterContent, setOptimisticChapterContent] = useOptimistic(chapterContent);
  ...
  return (
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">{optimisticChapterContent.type}</h1>
