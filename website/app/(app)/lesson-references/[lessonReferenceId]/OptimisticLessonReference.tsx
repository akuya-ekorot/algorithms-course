...
export default function OptimisticLessonReference({ 
  ...
  const [optimisticLessonReference, setOptimisticLessonReference] = useOptimistic(lessonReference);
  ...
  return (
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">{optimisticLessonReference.title}</h1>
